        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4">사원 등록</h4>
                    <!-- Basic Layout -->
                    <div class="row ">
                        <div class="col-xl">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form:form modelAttribute="userDto">
                                        <input type="hidden" name="insertId" value="<c:out value='${loginId}'/>"/>
                                        <input type="hidden" name="updateId" value="<c:out value='${loginId}'/>"/>
                                        <div class="mb-3">
                                            <label class="form-label" for="userId"> 아이디(Id)</label>
                                            <input class="form-control" type="text" id="userId" name="userId" placeholder="아이디를 입력해주세요." value="<c:out value='${userDto.userId}'/>"/>
                                        </div>
                                        ...
                                        <button type="button" id="submit_btn" class="ms-1 btn btn-primary float-end">등록</button>
                                        <button type="button" id="cancel_btn" class="ms-1 btn btn-primary float-end">취소</button>
                                    </form:form>
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#submit_btn').click(function () {
            ...
            if(formEle.userId.value.trim()=="") {
                alert("아이디를 입력해 주세요.");
                formEle.userId.focus();
                return false;
            }
            ...
            form.attr("action", "<c:url value='/employee/addemp'/>");
